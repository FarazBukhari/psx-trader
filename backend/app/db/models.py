...
class ForwardTrade(Base):
    ...
    # Signal provenance — JSON array of indicator names e.g. ["rsi","sma_crossover"]
    signal_sources  : Mapped[Optional[str]]  = mapped_column(Text)                               # NULL for pre-migration rows
